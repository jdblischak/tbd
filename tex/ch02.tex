...
unknown \citep{Kallmann1943, Comstock1978, Cobat2010, Moller2010}.
...
\citep{Alonso2011}; bacillus Calmette-Gu\'{e}rin (BCG), which is attenuated
...
BCG & bacillus Calmette-Gu\'{e}rin & Vaccine (attenuated \emph{M. bovis}) &
acid-fast \\
...
We collected buffy coats (\mytilde50 mL) from six healthy
...
reads mapping to more than one gene \citep{Liao2014}. There were no
...
\caption[Comparison to Tailleux et al., 2008.]{\textbf{Comparison to
  ...
  transcriptional response; see Fig. \ref{fig:differential-expression}A) from the two different
...
\caption[Joint Bayesian analysis results with gene
  ...
  Table \ref{tab:ch02-s3}, but with the genes from each pattern from each
...
\caption[Gene ontology results.]{\textbf{Gene ontology results.} (see
  ...
  three analyses in Fig. \ref{fig:joint-all}, \ref{fig:joint-18h},
