...
Supplementary Table \ref{tab:s1}) allows us to estimate error and variability
...
from three individuals (Supplementary Table \ref{tab:s2}).
...
Table \ref{tab:s3} for gene list). These 560 genes are enriched for genes involved
in protein translation, protein disassembly, and various biosynthetic
processes (Supplementary Table \ref{tab:s4}). Interestingly, among the genes whose
...
1.26-1.88 ng per microliter (Supplementary Table \ref{tab:s1}). A bulk sample, a
...
introduction of technical batch effects (Supplementary Table \ref{tab:s1}).
...
Fig. \ref{fig:s1}). In addition, we observed that some wells classified as
...
cells (Supplementary Table \ref{tab:s2}) were included in this analysis.
